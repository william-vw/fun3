...
def query(f_0, final_ctu):
    data.find(Literal(10, NS.xsd['int']), Iri('http://example.org/fib'), f_0, lambda s, p, o: final_ctu(o))
    rule_2(Literal(10, NS.xsd['int']), f_0, lambda n_1_m, f_2_m: final_ctu(f_2_m))
...
def rule_2_3(n_1, f_2, n1_3, n2_4, final_ctu):
    ...
    if n1_3 == Literal(0, NS.xsd['int']):
        rule_0(lambda: rule_2_4(n_1, f_2, Literal(0, NS.xsd['int']), n2_4, Literal(0, NS.xsd['int']), final_ctu))
...
def rule_2_4(n_1, f_2, n1_3, n2_4, f1_5, final_ctu):
    ...
    if n2_4 == Literal(0, NS.xsd['int']):
        rule_0(lambda: rule_2_5(n_1, f_2, n1_3, Literal(0, NS.xsd['int']), f1_5, Literal(0, NS.xsd['int']), final_ctu))
...
query(ANY, lambda f_0: emit(Triple(Literal(10, NS.xsd['int']), Iri('http://example.org/fib'), Var('f_0')), {'f_0': f_0}))
